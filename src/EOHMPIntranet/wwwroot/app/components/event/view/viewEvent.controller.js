(function () {
    ...
    function ViewEventController($location, $sessionStorage, $firebaseObject, EventService) {
    ...
    ViewEventController.$inject = ['$location', '$sessionStorage', '$firebaseObject', 'EventService'];
})();
